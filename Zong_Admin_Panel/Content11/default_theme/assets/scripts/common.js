$(document).ready(function() {
	...
	$(window).on('load resize', function() {
		if($(window).innerWidth() < 360) {
            $('.navbar-brand img.logo').attr('src', '/Content/default_theme/assets/img/logo-minimal.png');
		} else {
            $('.navbar-brand img.logo').attr('src', '/Content/default_theme/assets/img/logo.png');
		}
	});
