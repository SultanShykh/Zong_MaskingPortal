...
namespace Zong_Admin_Panel.Codebase
{
    public class GroupProcessing
    {
        ...
        public static void Get(DTParameters param, out DTResult<GroupMasterModel> result)
        {
            ...
            dynamic Records = AppDB.COR_USP_GetAllGroups(portalId: 8);
        ...
        {
            result = false;
            dynamic Records = AppDB.COR_USP_CreateGroup(Name: groupMastermodel.Name, CreatedDateTime: DateTime.Now, MenuId: groupMenu.MenuId, AllowEdit:groupMenu.AllowEdit, AllowCreate: groupMenu.AllowCreate, AllowDelete: groupMenu.AllowDelete, AllowView: groupMenu.AllowView, Users: users, ApplicationId:8);
